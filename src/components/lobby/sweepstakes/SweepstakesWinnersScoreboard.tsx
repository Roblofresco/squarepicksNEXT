...
export default function SweepstakesWinnersScoreboard({
  ...
  return (
    <div 
      className="bg-gradient-to-b from-background-primary from-0% to-[#B8860B] to-12% p-4 rounded-xl shadow-lg glow-border-gold max-w-xs sm:max-w-sm md:max-w-md mx-auto mt-6 mb-20"
    >
